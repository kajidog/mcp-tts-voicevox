 ...
 */
async function playAudioFile(filePath: string, description = ''): Promise<void> {
  try {
 ...
 */
async function testTextToSpeech(client: VoicevoxClient, speaker: number): Promise<AudioQuery> {
 ...
 * 音声ファイル生成機能をテストする
 */
async function testAudioFileGeneration(client: VoicevoxClient, query: AudioQuery, speaker: number): Promise<void> {
 ...
 * 再生速度変更機能をテストする
 */
async function testSpeedScale(client: VoicevoxClient, speaker: number): Promise<void> {
 ...
 * 音声生成キュー機能をテストする
 */
async function testAudioQueue(client: VoicevoxClient, query: AudioQuery, speaker: number): Promise<void> {
 ...
 */
async function testGenerateQueryTool(client: VoicevoxClient): Promise<AudioQuery> {
 ...
 */
async function testSynthesizeFileTool(client: VoicevoxClient, query: AudioQuery): Promise<string> {
